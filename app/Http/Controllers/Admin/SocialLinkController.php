...
use App\Http\Requests\AdmminSocialLinkStoreRequest;
...
class SocialLinkController extends Controller
{
     ...
     */
    public function store(AdmminSocialLinkStoreRequest $request)
    {
     ...
     */
    public function update(AdmminSocialLinkStoreRequest $request, string $id)
    {

...
class AdminAuthenticationController extends Controller
{
    ...
    public function sendResetLink(SendResetLinkRequest $request)
    {
        ...
        return redirect()->back()->with('success', __('admin.We have emailed your password reset link!'));
    }
    ...
    public function handleResetPassword(AdminResetPasswordRequest $request)
    {
        ...
        if (!$admin) {
            return redirect()->back()->withErrors(['email' => __('admin.Invalid token or email.')]);
        }
        ...
        return redirect()->route('admin.login')->with('success', __('admin.Your password has been reset successfully. You can now log in with your new password.'));

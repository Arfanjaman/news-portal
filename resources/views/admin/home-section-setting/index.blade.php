                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.home-section-setting.update') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_section_one" id="" class="form-control select2" style="width: 100%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_section_two" id="" class="form-control select2" style="width: 100%">
                                            <option value="">---{{ __('admin.Select') }}---</option>
                                            @foreach ($categories as $category)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_section_three" id="" class="form-control select2" style="width: 100%">
                                            <option value="">---{{ __('admin.Select') }}---</option>
                                            @foreach ($categories as $category)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_section_four" id="" class="form-control select2" style="width: 100%">
                                            <option value="">---{{ __('admin.Select') }}---</option>
                                            @foreach ($categories as $category)

                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    <div id="image-preview" class="image-preview mb-3">
                                        <label for="image-upload" id="image-label">{{ __('admin.admin.Choose File') }}</label>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div class="invalid-feedback">
                                        {{ __('admin.Please fill in the first name') }}
                                    </div>
                                      @error('name')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                         ...
                         @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div class="invalid-feedback">
                                        {{ __('admin.Please confirm the password') }}
                                    </div>
...
<!-- eita diye eikhan theke script master e push korbo kind of like dynamically rendering scripts-->
@push('scripts')
    <script>

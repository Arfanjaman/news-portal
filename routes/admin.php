...
//ei jaygay middleware e sudhu admin lekhle kaj kore na , will need to know why. for now path use kora  hoise
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => [\App\Http\Middleware\Admin::class]], function(){
